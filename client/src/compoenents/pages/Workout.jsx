...
const confirmDelete = (id) => {
  toast.warn(
    ({ closeToast }) => (
      <div className="fixed top-0 left-0 w-full h-full flex justify-center items-center">
        <div className="bg-black text-white p-4  shadow-md rounded-md">
          <p className="mb-4">Are you sure you want to delete this workout?</p>
    ...
    {
      position: "top-center", // Aligning toast to the top center of the page
      autoClose: false,
      closeButton: false,
      draggable: false,
    }
  ...
  const handleSaveEdit = async () => {
    try {
      ...
      await axios.put(
        `http://localhost:8080/workout/updateworkout/${selectedWorkout.id}`,
        updatedWorkout
      );
  ...
  return (
    <div>
      <ToastContainer />
      <div className="flex h-12 mt-1 rounded-lg relative bg-white">
        ...
        <div className="mt-2 mr-2">
          <button className="bg-green-300 hover:bg-green-500 py-1 px-4 rounded-lg">
            <Link to={"/addworkout"} className="flex items-center">
              Add
              <FaDumbbell />
            </Link>
          </button>
      ...
      <div className="flex flex-wrap rounded-md mt-6 ml-0.5 p-1 bg-white">
        {filteredWorkouts.map((workout, id) => (
          <div key={id} className="relative w-1/3 p-4 shadow-md rounded-xl">
            <div
              className="absolute top-0 right-0 text-xs text-gray-600 mr-2"
              style={{ fontSize: "8px" }}
            >
            ...
            <div className="flex items-center mb-2">
              ...
              <p>
                ...
                <span className="italic">s rest</span>
              </p>
            </div>
            <div className="flex items-center mb-2">
              <TiArrowRepeat size={20} className="mr-2 text-brown-600" />
              <p>
                {workout.st} <span className="italic">sets</span>
              </p>
            </div>
            <div className="absolute bottom-0 right-0 flex gap-2">
              <AiOutlineEdit
                size={20}
                className="cursor-pointer text-blue-500 mr-1 mb-2"
                onClick={() => handleEditWorkout(workout)}
              />
                    <AiFillDelete
                        
                size={20}
                className="cursor-pointer text-red-500 mr-2 mb-2"
      ...
      {editMode && selectedWorkout && (
        <div className="fixed top-0 left-0 w-full h-full flex justify-center items-center bg-black bg-opacity-50">
          <div className="bg-white p-4 rounded-lg">
            <h1 className="text-xl font-thin mb-4">Edit Workout</h1>
            <form className="w-full md:w-96">
              <div className="mb-4">
                <label htmlFor="name" className="block font-medium italic mb-1">
                  Workout Name
                </label>
                <input
                  id="name"
              ...
              <div className="mb-4">
                <label htmlFor="part" className="block font-medium italic mb-1">
                  Target Muscle
                </label>
                <input
                  id="part"
              ...
              <div className="mb-4">
                <label htmlFor="rept" className="block font-medium italic mb-1">
                  Repetitions
                </label>
                <input
                  id="rept"
              ...
              <div className="mb-4">
                <label
                  htmlFor="intervalTime"
                  className="block font-medium italic mb-1"
                >
                  Interval Time
                </label>
                <input
                  ...
                  type="number"
                  className="w-full p-2 border rounded-md focus:outline-none focus:border-blue-400"
                  value={selectedWorkout.intervalTime}
                  onChange={(e) =>
                    setSelectedWorkout({
                      ...selectedWorkout,
              ...
              <div className="mb-4">
                <label htmlFor="st" className="block font-medium italic mb-1">
                  Number of Sets
                </label>
                <input
                  id="st"
              ...
              <button
                type="button"
                className="bg-green-300 text-white py-2 px-4 rounded-md hover:bg-green-600"
              ...
              <button
                type="button"
                className="bg-blue-300 text-gray-700 py-2 px-4 rounded-md ml-2 hover:bg-blue-500"
      ...
      {showPostCard && (
        <div className="fixed top-0 left-0 w-full h-full flex justify-center items-center bg-black bg-opacity-50">
          <div className="bg-white p-4 rounded-lg">
            <h1 className="text-xl font-thin mb-4">Share an update</h1>
            <form className="w-full md:w-96">
              <div className="mb-4">
                <label
                  htmlFor="postContent"
